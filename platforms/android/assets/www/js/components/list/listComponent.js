app.component("list", {
    ...
    //      //"CREATE TABLE IF NOT EXISTS "+table+" (remote_id, user_id, app_id, court_name, case_number, first_party_name, second_party_name, case_stage, prev_date, next_date, status, created_at, updated_at, created_by, updated_by,is_on_remote)";
